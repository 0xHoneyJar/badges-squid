...
export const events = {
    ...
    FreeWhitelistAuthorizerChanged: event("0x3639a5ccd808ae1a86d60a5b738cd981061b7478ad45ae0b2aea54994938022b", "FreeWhitelistAuthorizerChanged(address)", {"newFreeWhitelistAuthorizerAddress": p.address}),
    ...
    WhitelistAuthorizerChanged: event("0x63651f54b104da052b16eb4d518afa4c0b1f6d2b77b9ab0f445787585234de37", "WhitelistAuthorizerChanged(address)", {"newWhitelistAuthorizerAddress": p.address}),
}
...
export const functions = {
    ...
    freeMintsByAddress: viewFun("0x5f17e265", "freeMintsByAddress(address)", {"_0": p.address}, p.uint8),
    getFreeWhitelistAuthorizer: viewFun("0x010adc4d", "getFreeWhitelistAuthorizer()", {}, p.address),
    getReservedNamesMinter: viewFun("0x0495a844", "getReservedNamesMinter()", {}, p.address),
    getWhitelistAuthorizer: viewFun("0x7c127a96", "getWhitelistAuthorizer()", {}, p.address),
    ...
    setFreeWhitelistAuthorizer: fun("0xbf806684", "setFreeWhitelistAuthorizer(address)", {"_freeWhitelistAuthorizer": p.address}, ),
    ...
    setWhitelistAuthorizer: fun("0x13d56a9c", "setWhitelistAuthorizer(address)", {"_whitelistAuthorizer": p.address}, ),
...
export class Contract extends ContractBase {
    ...
    freeMintsByAddress(_0: FreeMintsByAddressParams["_0"]) {
        return this.eth_call(functions.freeMintsByAddress, {_0})
    }

    getFreeWhitelistAuthorizer() {
        return this.eth_call(functions.getFreeWhitelistAuthorizer, {})
    }

    getReservedNamesMinter() {
        return this.eth_call(functions.getReservedNamesMinter, {})
    }

    getWhitelistAuthorizer() {
        return this.eth_call(functions.getWhitelistAuthorizer, {})
    }
...
export type FreeWhitelistAuthorizerChangedEventArgs = EParams<typeof events.FreeWhitelistAuthorizerChanged>
...
export type WhitelistAuthorizerChangedEventArgs = EParams<typeof events.WhitelistAuthorizerChanged>
...
export type FreeMintsByAddressParams = FunctionArguments<typeof functions.freeMintsByAddress>
export type FreeMintsByAddressReturn = FunctionReturn<typeof functions.freeMintsByAddress>

export type GetFreeWhitelistAuthorizerParams = FunctionArguments<typeof functions.getFreeWhitelistAuthorizer>
export type GetFreeWhitelistAuthorizerReturn = FunctionReturn<typeof functions.getFreeWhitelistAuthorizer>

export type GetReservedNamesMinterParams = FunctionArguments<typeof functions.getReservedNamesMinter>
export type GetReservedNamesMinterReturn = FunctionReturn<typeof functions.getReservedNamesMinter>

export type GetWhitelistAuthorizerParams = FunctionArguments<typeof functions.getWhitelistAuthorizer>
export type GetWhitelistAuthorizerReturn = FunctionReturn<typeof functions.getWhitelistAuthorizer>
...
export type SetFreeWhitelistAuthorizerParams = FunctionArguments<typeof functions.setFreeWhitelistAuthorizer>
export type SetFreeWhitelistAuthorizerReturn = FunctionReturn<typeof functions.setFreeWhitelistAuthorizer>
...
export type SetWhitelistAuthorizerParams = FunctionArguments<typeof functions.setWhitelistAuthorizer>
export type SetWhitelistAuthorizerReturn = FunctionReturn<typeof functions.setWhitelistAuthorizer>
