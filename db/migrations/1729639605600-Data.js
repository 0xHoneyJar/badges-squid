module.exports = class Data1729639605600 {
    name = 'Data1729639605600'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "cancel_boost" ("id" character varying NOT NULL, "user" text NOT NULL, "validator" text NOT NULL, "amount" numeric NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_fafeb2de8cc3c42d3b939afe0d8" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "drop_boost" ("id" character varying NOT NULL, "user" text NOT NULL, "validator" text NOT NULL, "amount" numeric NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_3799cfd4dd09d95e2f0383cf489" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "distribution_reward" ("id" character varying NOT NULL, "token" text NOT NULL, "amount" numeric NOT NULL, "distribution_id" character varying, CONSTRAINT "PK_0793c39ce09f062b7cacdcf1f33" PRIMARY KEY ("id"))`)
